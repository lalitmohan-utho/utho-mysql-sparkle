          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Choose the perfect MySQL Cloud Pricing plan for your needs. No hidden fees, no surprises—just transparent, predictable costs.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
              {/* Starter Plan */}
              <Card className="relative p-8 hover:shadow-medium transition-all duration-300">
                <CardHeader className="text-center p-0 mb-6">
                  <CardTitle className="text-2xl font-bold mb-2">Starter</CardTitle>
                  <CardDescription className="text-base">Perfect for small applications</CardDescription>
                  <div className="mt-4">
              ...
              {/* Professional Plan */}
              <Card className="relative p-8 hover:shadow-medium transition-all duration-300 border-primary shadow-medium">
              ...
              <Card className="relative p-8 hover:shadow-medium transition-all duration-300">
                <CardHeader className="text-center p-0 mb-6">
                  ...
                  <CardDescription className="text-base">For large-scale applications</CardDescription>
                  <div className="mt-4">
                ...
                <CardContent className="p-0">
                  <ul className="space-y-3 mb-8">
                    ...
                    <li className="flex items-center">
                      <Check className="h-5 w-5 text-primary mr-3" />
                      <span>VPC & Private Networking</span>
                    </li>
                  </ul>
                  <Button className="w-full" variant="outline" size="lg">
                    See Pricing
            ...
            <div className="text-center mt-12">
              <p className="text-muted-foreground mb-4">
                Need a custom solution? We offer tailored pricing for high-volume deployments.
              </p>
